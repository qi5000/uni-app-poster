(global["webpackJsonp"] = global["webpackJsonp"] || []).push([["wxcomponents/hch-poster/hch-poster"],{

/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader/index.js?!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/vue-loader/lib/index.js?!E:\\uni-app\\poster\\wxcomponents\\hch-poster\\hch-poster.vue?vue&type=script&lang=js&":
/*!**********************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/vue-loader/lib??vue-loader-options!E:/uni-app/poster/wxcomponents/hch-poster/hch-poster.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
var _default =
{
  ...
  methods: {
    ...
    roundRect: function roundRect(ctx, x, y, w, h, r, fillColor, strokeColor, btn) {
      // 开始绘制
      ctx.beginPath();
      ...
      ctx.lineTo(x, y + r);
      if (btn == 'btn') {
        var grd = ctx.createLinearGradient(0, 0, 200, 0); //渐变色
    ...
    /**
       ...
       * lineNumber: 显示几行
       */
    canvasMultiLineText: function canvasMultiLineText(ctx, text, contentWidth, lineNumber) {
    ...
    codeImg: function codeImg() {var _this2 = this;
      return new Promise(function (resolve, reject) {
        request({
          ...
          data: {
            version: _this2.$parent.globalData.version,
            scene: "sku=".concat(_this2.sku),
        ...
        then(function (res) {
          if (res.data.code == 0) {
            ...
            var filePath = "".concat(wx.env.USER_DATA_PATH, "/").concat(FILE_BASE_NAME, ".jpg");
            fsm.writeFile({
              filePath: filePath,
              data: res.data.data,
              encoding: 'binary',
    ...
    // 生成海报
    createCanvasImage: function createCanvasImage() {var _this3 = this;
      ...
      var scaleW = this.phoneW / 375; //按照苹果留 375*667比例 其他型号手机等比例缩放 显示
      var scaleH = this.phoneH / 667; //按照苹果留 375*667比例 其他型号手机等比例缩放 显示
      console.log(this.phoneH, this.phoneW);
      var ctx = wx.createCanvasContext('myCanvas');
      var url = this.posterObj.url; //商品主图
      var zpPriceIcon = this.posterObj.icon; //图标
      var code = this.posterObj.code;
      var closeBtn = 'https://imgzuipin.oss-cn-hangzhou.aliyuncs.com/mp_zuipin/poster/close_btn.png';
      console.log(ctx);
      console.log(this);
      ...
      setTimeout(function () {
        ...
        var text = _this3.posterObj.title;
        var row = _this3.canvasMultiLineText(ctx, text, _this3.phoneW - 130, 2); //计算绘制的2行文本
        var contentTextY = 360; // 这段文字起始的y位置
        var leftSpace = 65; // 这段文字起始的X位置
        var textLineHeight = 18; // 一行文字加一行行间距
        for (var b = 0; b < row.length; b++) {//一行一行绘制文本
          ctx.fillText(row[b], leftSpace, (contentTextY + textLineHeight * b - 15) * scaleH, _this3.phoneW - 130);
          ctx.draw(true);
        }
      }, 500);
      // 海报商品title end
      ...
      var zpPrice = this.posterObj.discountPrice; //会员价格
      var orignPrice = this.posterObj.orignPrice; //市场价

      var zpPriceW = ctx.measureText(zpPrice).width; //文本的宽度
      ctx.fillText(zpPrice, 120, 396 * scaleH, zpPriceW);

      ctx.beginPath(); //开始一个新的路径
      ctx.setFontSize(10); //设置字体大小，默认10
      ctx.setFillStyle('#999'); //文字颜色：默认黑色
      var orignPriceW = ctx.measureText(orignPrice).width; //去掉市场价
      ctx.fillText("\uFFE5".concat(orignPrice), 120 + zpPriceW + 5, 395 * scaleH, orignPriceW); //5价格间距
    ...
    // 保存到系统相册
    saveCanvasImage: function saveCanvasImage() {
      console.log('点击了保存');
      wx.showLoading({
        title: '保存中...' });
    ...
    // 取消海报
    canvasCancelEvn: function canvasCancelEvn() {
      console.log();
...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js?!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader/index.js?!./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/lib/loader.js?!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader/index.js?!./node_modules/vue-loader/lib/index.js?!E:\\uni-app\\poster\\wxcomponents\\hch-poster\\hch-poster.vue?vue&type=style&index=0&lang=scss&":
/*!**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--8-oneOf-1-0!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-1!./node_modules/css-loader??ref--8-oneOf-1-2!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--8-oneOf-1-3!./node_modules/sass-loader/lib/loader.js??ref--8-oneOf-1-4!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-5!./node_modules/vue-loader/lib??vue-loader-options!E:/uni-app/poster/wxcomponents/hch-poster/hch-poster.vue?vue&type=style&index=0&lang=scss& ***!
  \**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader/index.js?!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/template.js!./node_modules/vue-loader/lib/index.js?!E:\\uni-app\\poster\\wxcomponents\\hch-poster\\hch-poster.vue?vue&type=template&id=762e0302&":
/*!**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--17-0!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/template.js!./node_modules/vue-loader/lib??vue-loader-options!E:/uni-app/poster/wxcomponents/hch-poster/hch-poster.vue?vue&type=template&id=762e0302& ***!
  \**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
/***/ "E:\\uni-app\\poster\\wxcomponents\\hch-poster\\hch-poster.vue":
/*!****************************************************************!*\
  !*** E:/uni-app/poster/wxcomponents/hch-poster/hch-poster.vue ***!
  \****************************************************************/
/*! no static exports found */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _hch_poster_vue_vue_type_template_id_762e0302___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./hch-poster.vue?vue&type=template&id=762e0302& */ "E:\\uni-app\\poster\\wxcomponents\\hch-poster\\hch-poster.vue?vue&type=template&id=762e0302&");
/* harmony import */ var _hch_poster_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./hch-poster.vue?vue&type=script&lang=js& */ "E:\\uni-app\\poster\\wxcomponents\\hch-poster\\hch-poster.vue?vue&type=script&lang=js&");
...
/* harmony import */ var _hch_poster_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./hch-poster.vue?vue&type=style&index=0&lang=scss& */ "E:\\uni-app\\poster\\wxcomponents\\hch-poster\\hch-poster.vue?vue&type=style&index=0&lang=scss&");
...
var component = Object(_D_HBuiderX_HBuilderX_2_0_1_20190614_HBuilderX_plugins_uniapp_cli_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _hch_poster_vue_vue_type_template_id_762e0302___WEBPACK_IMPORTED_MODULE_0__["render"],
  _hch_poster_vue_vue_type_template_id_762e0302___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "E:/uni-app/poster/wxcomponents/hch-poster/hch-poster.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "E:\\uni-app\\poster\\wxcomponents\\hch-poster\\hch-poster.vue?vue&type=script&lang=js&":
/*!*****************************************************************************************!*\
  !*** E:/uni-app/poster/wxcomponents/hch-poster/hch-poster.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************